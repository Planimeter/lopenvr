...
{
 struct HmdVector3_t vCorners[4];
} HmdQuad_t;
...
{
 uint64_t m_nImage;
 struct VkDevice_T * m_pDevice;
 struct VkPhysicalDevice_T * m_pPhysicalDevice;
 struct VkInstance_T * m_pInstance;
 struct VkQueue_T * m_pQueue;
...
typedef struct VRControllerState_t
{
 ...
 struct VRControllerAxis_t rAxis[5];
} VRControllerState_t;
...
{
 struct RenderModel_Vertex_t * rVertexData;
...
struct VR_IVRSystem_FnTable
{
 ...
 _Bool (__stdcall *ComputeDistortion)(EVREye eEye, float fU, float fV, struct DistortionCoordinates_t * pDistortionCoordinates);
 struct HmdMatrix34_t (__stdcall *GetEyeToHeadTransform)(EVREye eEye);
 _Bool (__stdcall *GetTimeSinceLastVsync)(float * pfSecondsSinceLastVsync, uint64_t * pulFrameCounter);
 int32_t (__stdcall *GetD3D9AdapterIndex)();
 void (__stdcall *GetDXGIOutputInfo)(int32_t * pnAdapterIndex);
 _Bool (__stdcall *IsDisplayOnDesktop)();
 _Bool (__stdcall *SetDisplayVisibility)(_Bool bIsVisibleOnDesktop);
 ...
 _Bool (__stdcall *IsTrackedDeviceConnected)(TrackedDeviceIndex_t unDeviceIndex);
 _Bool (__stdcall *GetBoolTrackedDeviceProperty)(TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, ETrackedPropertyError * pError);
 ...
 _Bool (__stdcall *PollNextEvent)(struct VREvent_t * pEvent, uint32_t uncbVREvent);
 _Bool (__stdcall *PollNextEventWithPose)(ETrackingUniverseOrigin eOrigin, struct VREvent_t * pEvent, uint32_t uncbVREvent, TrackedDevicePose_t * pTrackedDevicePose);
 ...
 _Bool (__stdcall *GetControllerState)(TrackedDeviceIndex_t unControllerDeviceIndex, VRControllerState_t * pControllerState, uint32_t unControllerStateSize);
 _Bool (__stdcall *GetControllerStateWithPose)(ETrackingUniverseOrigin eOrigin, TrackedDeviceIndex_t unControllerDeviceIndex, VRControllerState_t * pControllerState, uint32_t unControllerStateSize, struct TrackedDevicePose_t * pTrackedDevicePose);
 ...
 _Bool (__stdcall *CaptureInputFocus)();
 void (__stdcall *ReleaseInputFocus)();
 _Bool (__stdcall *IsInputFocusCapturedByAnotherProcess)();
...
struct VR_IVRTrackedCamera_FnTable
{
 ...
 EVRTrackedCameraError (__stdcall *HasCamera)(TrackedDeviceIndex_t nDeviceIndex, _Bool * pHasCamera);
...
{
 EVRApplicationError (__stdcall *AddApplicationManifest)(char * pchApplicationManifestFullPath, _Bool bTemporary);
 EVRApplicationError (__stdcall *RemoveApplicationManifest)(char * pchApplicationManifestFullPath);
 _Bool (__stdcall *IsApplicationInstalled)(char * pchAppKey);
 ...
 _Bool (__stdcall *CancelApplicationLaunch)(char * pchAppKey);
 ...
 _Bool (__stdcall *GetApplicationPropertyBool)(char * pchAppKey, EVRApplicationProperty eProperty, EVRApplicationError * peError);
 ...
 EVRApplicationError (__stdcall *SetApplicationAutoLaunch)(char * pchAppKey, _Bool bAutoLaunch);
 _Bool (__stdcall *GetApplicationAutoLaunch)(char * pchAppKey);
 EVRApplicationError (__stdcall *SetDefaultApplicationForMimeType)(char * pchAppKey, char * pchMimeType);
 _Bool (__stdcall *GetDefaultApplicationForMimeType)(char * pchMimeType, char * pchAppKeyBuffer, uint32_t unAppKeyBufferLen);
 _Bool (__stdcall *GetApplicationSupportedMimeTypes)(char * pchAppKey, char * pchMimeTypesBuffer, uint32_t unMimeTypesBuffer);
 ...
 _Bool (__stdcall *IsQuitUserPromptRequested)();
...
struct VR_IVRChaperone_FnTable
{
 ...
 _Bool (__stdcall *GetPlayAreaSize)(float * pSizeX, float * pSizeZ);
 _Bool (__stdcall *GetPlayAreaRect)(struct HmdQuad_t * rect);
 ...
 _Bool (__stdcall *AreBoundsVisible)();
 void (__stdcall *ForceBoundsVisible)(_Bool bForce);
};

struct VR_IVRChaperoneSetup_FnTable
{
 _Bool (__stdcall *CommitWorkingCopy)(EChaperoneConfigFile configFile);
 void (__stdcall *RevertWorkingCopy)();
 _Bool (__stdcall *GetWorkingPlayAreaSize)(float * pSizeX, float * pSizeZ);
 _Bool (__stdcall *GetWorkingPlayAreaRect)(struct HmdQuad_t * rect);
 _Bool (__stdcall *GetWorkingCollisionBoundsInfo)(struct HmdQuad_t * pQuadsBuffer, uint32_t * punQuadsCount);
 _Bool (__stdcall *GetLiveCollisionBoundsInfo)(struct HmdQuad_t * pQuadsBuffer, uint32_t * punQuadsCount);
 _Bool (__stdcall *GetWorkingSeatedZeroPoseToRawTrackingPose)(struct HmdMatrix34_t * pmatSeatedZeroPoseToRawTrackingPose);
 _Bool (__stdcall *GetWorkingStandingZeroPoseToRawTrackingPose)(struct HmdMatrix34_t * pmatStandingZeroPoseToRawTrackingPose);
 ...
 _Bool (__stdcall *GetLiveSeatedZeroPoseToRawTrackingPose)(struct HmdMatrix34_t * pmatSeatedZeroPoseToRawTrackingPose);
 void (__stdcall *SetWorkingCollisionBoundsTagsInfo)(uint8_t * pTagsBuffer, uint32_t unTagCount);
 _Bool (__stdcall *GetLiveCollisionBoundsTagsInfo)(uint8_t * pTagsBuffer, uint32_t * punTagCount);
 _Bool (__stdcall *SetWorkingPhysicalBoundsInfo)(struct HmdQuad_t * pQuadsBuffer, uint32_t unQuadsCount);
 _Bool (__stdcall *GetLivePhysicalBoundsInfo)(struct HmdQuad_t * pQuadsBuffer, uint32_t * punQuadsCount);
 _Bool (__stdcall *ExportLiveToBuffer)(char * pBuffer, uint32_t * pnBufferLength);
 _Bool (__stdcall *ImportFromBufferToWorking)(char * pBuffer, uint32_t nImportFlags);
};
...
struct VR_IVRCompositor_FnTable
{
 ...
 _Bool (__stdcall *GetFrameTiming)(struct Compositor_FrameTiming * pTiming, uint32_t unFramesAgo);
 ...
 void (__stdcall *FadeToColor)(float fSeconds, float fRed, float fGreen, float fBlue, float fAlpha, _Bool bBackground);
 struct HmdColor_t (__stdcall *GetCurrentFadeColor)(_Bool bBackground);
 void (__stdcall *FadeGrid)(float fSeconds, _Bool bFadeIn);
 ...
 _Bool (__stdcall *IsFullscreen)();
 uint32_t (__stdcall *GetCurrentSceneFocusProcess)();
 uint32_t (__stdcall *GetLastFrameRenderer)();
 _Bool (__stdcall *CanRenderScene)();
 void (__stdcall *ShowMirrorWindow)();
 void (__stdcall *HideMirrorWindow)();
 _Bool (__stdcall *IsMirrorWindowVisible)();
 void (__stdcall *CompositorDumpImages)();
 _Bool (__stdcall *ShouldAppRenderWithLowResources)();
 void (__stdcall *ForceInterleavedReprojectionOn)(_Bool bOverride);
 void (__stdcall *ForceReconnectProcess)();
 void (__stdcall *SuspendRendering)(_Bool bSuspend);
 ...
 _Bool (__stdcall *ReleaseSharedGLTexture)(glUInt_t glTextureId, glSharedTextureHandle_t glSharedTextureHandle);
...
struct VR_IVROverlay_FnTable
{
 ...
 EVROverlayError (__stdcall *SetOverlayFlag)(VROverlayHandle_t ulOverlayHandle, VROverlayFlags eOverlayFlag, _Bool bEnabled);
 EVROverlayError (__stdcall *GetOverlayFlag)(VROverlayHandle_t ulOverlayHandle, VROverlayFlags eOverlayFlag, _Bool * pbEnabled);
 ...
 _Bool (__stdcall *IsOverlayVisible)(VROverlayHandle_t ulOverlayHandle);
 ...
 _Bool (__stdcall *PollNextOverlayEvent)(VROverlayHandle_t ulOverlayHandle, struct VREvent_t * pEvent, uint32_t uncbVREvent);
 ...
 _Bool (__stdcall *ComputeOverlayIntersection)(VROverlayHandle_t ulOverlayHandle, struct VROverlayIntersectionParams_t * pParams, struct VROverlayIntersectionResults_t * pResults);
 _Bool (__stdcall *HandleControllerOverlayInteractionAsMouse)(VROverlayHandle_t ulOverlayHandle, TrackedDeviceIndex_t unControllerDeviceIndex);
 _Bool (__stdcall *IsHoverTargetOverlay)(VROverlayHandle_t ulOverlayHandle);
 ...
 _Bool (__stdcall *IsDashboardVisible)();
 _Bool (__stdcall *IsActiveDashboardOverlay)(VROverlayHandle_t ulOverlayHandle);
 ...
 EVROverlayError (__stdcall *ShowKeyboard)(EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eLineInputMode, char * pchDescription, uint32_t unCharMax, char * pchExistingText, _Bool bUseMinimalMode, uint64_t uUserValue);
 EVROverlayError (__stdcall *ShowKeyboardForOverlay)(VROverlayHandle_t ulOverlayHandle, EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eLineInputMode, char * pchDescription, uint32_t unCharMax, char * pchExistingText, _Bool bUseMinimalMode, uint64_t uUserValue);
...
struct VR_IVRRenderModels_FnTable
{
 ...
 _Bool (__stdcall *GetComponentState)(char * pchRenderModelName, char * pchComponentName, VRControllerState_t * pControllerState, struct RenderModel_ControllerMode_State_t * pState, struct RenderModel_ComponentState_t * pComponentState);
 _Bool (__stdcall *RenderModelHasComponent)(char * pchRenderModelName, char * pchComponentName);
...
struct VR_IVRSettings_FnTable
{
 ...
 _Bool (__stdcall *Sync)(_Bool bForce, EVRSettingsError * peError);
 void (__stdcall *SetBool)(char * pchSection, char * pchSettingsKey, _Bool bValue, EVRSettingsError * peError);
 ...
 _Bool (__stdcall *GetBool)(char * pchSection, char * pchSettingsKey, EVRSettingsError * peError);
